...
/// This command is typically used in a CQRS pattern to encapsulate the data required to create an admin
/// entity. The command returns the unique identifier of the newly created admin upon successful execution.
/// </summary>
